...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO students (name, email, student_id, phone, course) VALUES ('$name', '$email', '$student_id', '$phone', '$course')";
  $result = mysqli_query($conn, $sql);
...
<body>
  ...
  <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="insertModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="insertModalLabel">Add Detail</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
